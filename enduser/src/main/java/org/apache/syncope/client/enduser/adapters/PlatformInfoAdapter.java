...
import org.apache.syncope.client.enduser.ChorevolutionEnduserApplication;
...
public final class PlatformInfoAdapter {
    ...
    public static PlatformInfoRequest toPlatformInfoRequest(final PlatformInfo platformInfo,
        ...
        request.setViewGroupsEnabled(ChorevolutionEnduserApplication.get().isViewGroupsEnabled());
        return request;
    }
